...
# Marc Poulhi鑚. Additions and changes by Mike Meylan, Malte, Anthony Miller and
# Sergey Fomel.
#
...
tr_list2 = [
    ...
    (r"\\begin{verbatim}", (lambda : "<code>"), start_verbatim),
    (r"\\end{verbatim}", (lambda : "</code>"), end_verbatim),
